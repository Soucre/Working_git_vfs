...
<p >
    ...
    <div><asp:Button ID="approveButton" runat="server" OnClick="approveButton_Click"/> <asp:Button ID="rejectedButton" runat="server"  Text="tu choi" OnClick="rejectedButton_Click"/></div>
    <cc1:Pager OnCommand="topPaging_Command" ShowFirstLast="true" id="topPaging" PageSize="10" runat="server">
        ...
        <table width="1000" border="0">  
            <tr>
                ...
                <td></td>
                <td><%= Resources.NewsList.detail %></td>
            </tr>
            <tr>
                <td colspan="5" style="vertical-align:top">
                    <table width="100%" height="252" border="0" align="left">
                        <asp:Repeater ID="newsRepeater" runat="server">
                            <ItemTemplate>                               
                                <tr>
                                    <td width="5%"><input id="selectedItem" name="selectedItem" type="checkbox" value="<%# ((Vfs.WebCrawler.Entities.StockNew)(Container.DataItem)).NewsId %>" onclick="SingleCheck(this);"/></td>
