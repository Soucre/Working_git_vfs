<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ContentTeplateDetail.aspx.cs" Inherits="ContentTeplateDetail" Title="Chi tiet noi dung mau" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
    ...
    <table>        
            <tr>
                <td><%=Resources.UIResource.NameTemplate%><span class="inforError">(*)</span></td>
                <td style="width: 158px"><input runat="server" id="inputNameTemplate" maxlength="50" style="width: 267px" /></td>
            ...
            <tr>
                ...
                <td style="width: 158px"><input runat="server" id="inputSuject" maxlength="50" style="width: 268px" /></td>
            </tr>
            <tr>
