    ...
    public abstract class CustomerDAOBase
    {
        ...
        public virtual void CreateCustomer(Customer customer)
        {
            try
            {
                ...
                DbCommand dbCommand = database.GetStoredProcCommand("spCustomersInsert");
        ...
        public virtual void UpdateCustomer(Customer customer)
        {
            ...
            {
                Database database = DatabaseFactory.CreateDatabase("CoreSecurityServiceConnection");
                DbCommand dbCommand = database.GetStoredProcCommand("spCustomersUpdate");            
        ...
        public virtual void DeleteCustomer(string customerId)
        {
            ...
            {
                Database database = DatabaseFactory.CreateDatabase("CoreSecurityServiceConnection");
                DbCommand dbCommand = database.GetStoredProcCommand("spCustomersDelete");
        ...
        {            
            ...
            {
                Database database = DatabaseFactory.CreateDatabase("CoreSecurityServiceConnection");
                DbCommand dbCommand = database.GetStoredProcCommand("spCustomersGet");
        ...
        {            
            ...
            {
                Database database = DatabaseFactory.CreateDatabase("CoreSecurityServiceConnection");
                DbCommand dbCommand = database.GetStoredProcCommand("spCustomersGetList");
