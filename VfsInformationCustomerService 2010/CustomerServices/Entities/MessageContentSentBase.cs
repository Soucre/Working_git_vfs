...
{
	[Serializable]
	public class MessageContentSentBase
	{
		...
		private long				_MessageContentSentID = 0;
		...
		
		{
			...
			this._MessageContentSentID = MessageContentSentID;
		...
		public long MessageContentSentID
		{
			get { return _MessageContentSentID; }
			set { _MessageContentSentID = value; }
		}
	...
	public enum MessageContentSentColumns
	{
		MessageContentID,
		ContentTemplateID,
		ServiceTypeID,
