...
{
	[Serializable]
	public class IncomingMessageContentBase
	{
		
		#region Variable Declarations
		private int				_IncomingMessageContentID = 0;
		...
		#region Constructors
		public IncomingMessageContentBase() {}
		
		public IncomingMessageContentBase (
			int IncomingMessageContentID,
			int ServiceTypeID,
			string Sender,
			string Receiver,
			string Subject,
		...
		public int IncomingMessageContentID
		{
	...
	public enum IncomingMessageContentColumns
	{
