...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[spContentTemplateAttachementGetListByContentTemplateID]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[spContentTemplateAttachementGetListByContentTemplateID]
GO
...
**    
*******************************************************************************/
CREATE PROCEDURE [dbo].spContentTemplateAttachementGetListByContentTemplateID
...
SELECT @TotalRecords = COUNT(*) FROM [ContentTemplateAttachement] WHere #TempContentTemplateAttachement
