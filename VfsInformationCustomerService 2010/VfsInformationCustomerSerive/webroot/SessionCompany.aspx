<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="SessionCompany.aspx.cs" Inherits="SessionCompany"%>
<%@ Register Assembly="jQueryDatePicker" Namespace="Westwind.Web.Controls" TagPrefix="ww" %>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
    <h1><%=Resources.UIResource.SessionCompanyTitle%></h1>
...
<div>
    <select runat="server" id="exportSessionCompanySelect">
