...
CREATE TABLE `debug` (
  ...
  `text` text NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=11253 DEFAULT CHARSET=latin1;
...
INSERT INTO `debug` VALUES (11248,'ubc_Namecard-01.jpg'),(11249,'Target file: dist/img/product/5801d91ee70b6-ubc_Namecard-01.jpg'),(11250,'Variant ID: 386'),(11251,'Update record ok'),(11252,'');
